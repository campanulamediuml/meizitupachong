...
class chessboard (object):
    ...
    def __init__ (self, forbidden = 0):
        self.__board = [ [ 0 for n in xrange(19) ] for m in xrange(19) ]
    ...
    def show (self):
        ...
        color1 = 10
        color2 = 13
        for row in xrange(19):
            print chr(ord('A') + row),
            for col in xrange(19):
...
class evaluation (object):
    ...
    def __init__ (self):
        self.POS = []
        for i in xrange(19):
            row = [ (7 - max(abs(i - 7), abs(j - 7))) for j in xrange(19) ]
    ...
    def __analysis_right (self, board, i, j):
        line, result, record = self.line, self.result, self.record
        TODO = self.TODO
        if 18 - i < j: x, y, realnum = j - 18 + i, 18, 18 - i
...
class searcher (object):
    ...
    def __init__ (self):
        ...
        self.board = [ [ 0 for n in xrange(19) ] for i in xrange(19) ]
        self.gameover = 0
        self.overvalue = 0
        self.maxdepth = 3
...
def gamemain():
    ...
    # hand = raw_input('which color you want?(w or b):')
    ...
    while 1:
        ...
        while 1:
            ...
            if len(text) == 2:
                ...
                if tr >= 0 and tc >= 0 and tr < 19 and tc < 19:
                    if b[tr][tc] == 0:
                        row, col = tr, tc
                        break
                    else:
